...
public class TestApp{
    ...
    public static void main(String args[]) {
        try{
            ...
            switch (args[1]) {
                case "BACKUP":
                    remote_object_mdb.backupFile("D:\\Data\\GitHub\\sdis1718-t1g03\\assets\\" + args[2], Integer.parseInt(args[3]));
                    break;
                case "RESTORE":
                    remote_object_mc.restoreFile(args[2]);
                    break;
                case "DELETE":
                    remote_object_mc.deleteFile("D:\\Data\\GitHub\\sdis1718-t1g03\\assets\\" + args[2]);
                    break;
                case "RECLAIM":
